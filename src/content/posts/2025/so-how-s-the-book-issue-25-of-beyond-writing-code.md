...
What _exactly_ was I writing about? Was this a book about how to get promoted? Was it a book about being happier at work? Was this about processes and ways of working? Was it about soft skills development (ho hum)?
...
​[Capacities](https://capacities.io/) is a flexible note-taking tool of sorts. You create "objects" in it, and then you can link objects to each other. A book object might be linked to a person (the author, say), or to some of its main ideas. Then the person and the ideas could in turn be linked to other objects (maybe to a talk the person gave, or a blog post.
