---
title: "Draft outline, issue 6 of Beyond Writing Code"
date: "2025-06-25"
excerpt: "A sneak preview of my book outline and structure."
categories: ["writing","book"]
tags: ["Beyond Writing Code newsletter","sneak preview"]
published: true
comments: []
---

_Beyond Writing Code #6_
...
_This isn’t part of the outline, it’s here to keep me focused. If I’m not talking about the problem, the solution, or the questions, it’s off topic._
...
_Here's the actual outline. Items are not necessarily in order of appearance._
...
*   Are you the resident expert on \_\_\_?
*   How much are people turning to you for your leadership and input?
*   _And how much do you have the knowledge and skills from the sections that follow??_

What’s after (senior) developer?

*   It's okay to stay put - advancement doesn't have to be your goal
*   Management
*   Staff+ Engineer (tech lead, principal, distinguished, "any engineering beyond senior"; Tanya Reilly’s _The Staff Engineer’s Path_)
*   TPM
*   Architecture
*   Adjacent:
...
*   Callout: Understanding fit (Andre Martin’s _Wrong Fit, Right Fit_)
...
*   Possibly: project and product models (_Project to Product,_ Mik Kersten)
...
*   Sorry, it’s “what’s in it for _them_” when we say “WIIFM”
...
*   (_Turn the Ship Around!,_ Marquet)
...
Lean (Possibly _Lean Startup?_)

DevOps (_Phoenix Project_, Kim et al)

Limiting WIP (_Flow Engineering_, Pereira et al)

(_Accelerate_, Forsgren et al)
...
*   _Observability Engineering_, Majors et al

Learning fast

*   Callout: about “move fast and break things”

Slowification / Simplification / Amplification (_Wiring the Winning Organization,_ Kim & Spear)

*   maybe _Making Work Visible,_ DeGrandis

Theory of Constraints (_The Goal,_ Goldratt)
