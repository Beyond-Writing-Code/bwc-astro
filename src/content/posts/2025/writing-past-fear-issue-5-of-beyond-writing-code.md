...
As I got to be more senior, I used to joke that I was "contractually obligated" to break production at least once per year. _Of course_ you don't want to break production, _of course_ you want to be careful with the live running system that supports real customers using the real product.
...
_Of course_ I don't want to say something foolish or poorly thought out in my newsletter. _Of course_ I want to take care with what I write.
...
For a minute, I actually had two books (!) that I'm working on. There's what I think of as "the real book." Working title: _Beyond Writing Code_, the book about lessons learned as a developer. I've decided to go with "hybrid" publishing for that (a middle ground between traditional publishing houses and completely self-published).
...
.ck-poll-39 tr.ck-poll-option:hover { background-color: #1e1e1e10; }

What stresses you out most about meetings?

[

](https://polls.kit.com/24704?option_id=87891&token=preview)

[Attending them all - I have too many, they're often not a good use of my time](https://polls.kit.com/24704?option_id=87891&token=preview)

[

](https://polls.kit.com/24704?option_id=87892&token=preview)

[Running them - Actually getting done what we need to get done](https://polls.kit.com/24704?option_id=87892&token=preview)

[

](https://polls.kit.com/24704?option_id=87893&token=preview)

[Presenting - Being in the spotlight, speaking in front of the group](https://polls.kit.com/24704?option_id=87893&token=preview)

[

](https://polls.kit.com/24704?option_id=87894&token=preview)

[Something else (email and say more!)](https://polls.kit.com/24704?option_id=87894&token=preview)
...
Have [a Forrest Brazeal video about going to production](https://www.youtube.com/watch?v=NaR8WlLtPw0).

And I just assembled a page of things I [recommend](https://www.beyondwritingcode.com/recommend/).
